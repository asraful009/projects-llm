...
def main():
  ...
  meta_embeddings = []
  faq_embeddings = []
  if not os.path.isfile("ai_data/chuck_meta_embedding.json"):
    if not os.path.isfile(".ai_data/chuck_for_faqs.json"):
      ...
      with open('.ai_data/chuck_for_faqs.json', 'r') as file:
        meta_faq = json.load(file)
      with open('.ai_data/chuck_meta.json', 'r') as file:
        meta = json.load(file)
    ...
    with open('.ai_data/chuck_meta_embedding.json', 'r') as file:
      meta_embeddings = json.load(file)
    with open('.ai_data/chuck_faq_embedding.json', 'r') as file:
      faq_embeddings = json.load(file)
